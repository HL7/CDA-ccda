...
* insert OldSection(#59773-2, Procedure specimens taken Narrative, 2.16.840.1.113883.10.20.22.2.31)

* text ^short = "The Procedure Specimens Taken section SHALL list all specimens removed or SHALL explicitly state that no specimens were taken (CONF:81-8742)."