...
* insert OldSection(#46239-0, [[Chief complaint+Reason for visit Narrative]], 2.16.840.1.113883.10.20.22.2.13)
* obeys no-cc-rfv

Invariant: no-cc-rfv
Description: "When using this section, the Chief Complaint Section and the Reason for Visit Section SHALL NOT be used."
Severity: #error
Expression: "%resource.component.structuredBody.component.where(section.hasTemplateIdOf(ChiefComplaintSection).exists() or section.hasTemplateIdOf(ReasonforVisitSection).exists()).empty()"
