...
Severity: #error
Expression: "%resource.component.structuredBody.component.where(section.hasTemplateIdOf(AssessmentSection) | section.hasTemplateIdOf(PlanofTreatmentSection)).empty()"