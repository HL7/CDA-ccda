...
* insert OldSection(#11537-8, Surgical drains Narrative, 2.16.840.1.113883.10.20.7.13)

* text ^short = "There SHALL be a statement providing details of the drains placed or SHALL explicitly state there were no drains placed (CONF:81-8056)."