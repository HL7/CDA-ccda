  ...
  * participantRole 1..1
    ...
    * playingEntity 1..1
      ...
      * code from $2.16.840.1.113762.1.4.1267.43 (preferred)
        * ^comment = "This playingEntity SHALL contain exactly one [1..1] code, which MAY be selected from ValueSet Allergen Concepts (Medications, Foods, and Environmental Substances) including refutations urn:oid:2.16.840.1.113762.1.4.1267.43 DYNAMIC (CONF:1098-16324)."
