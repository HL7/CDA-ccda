...
<img style="padding-top:0;padding-bottom:30px;display:block;" width="800px" src="cda_problemactandproblemobs_timing.png"/>
...
* insert LogicalModelTemplate(problem-concern-act, 2.16.840.1.113883.10.20.22.4.3, 2024-05-01)
