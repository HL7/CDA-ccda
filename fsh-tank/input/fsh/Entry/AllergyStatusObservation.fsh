...
* templateId[primary] ^comment = "SHALL contain exactly one [1..1] templateId (CONF:1198-7317) such that it"
  * root 1..1
  * root = "2.16.840.1.113883.10.20.22.4.28"
    * ^comment = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.22.4.28\" (CONF:1198-10490)."
  * extension 1..1
  * extension = "2019-06-20"
    * ^comment = "SHALL contain exactly one [1..1] @extension=\"2019-06-20\" (CONF:1198-32962)."
* code 1..1
