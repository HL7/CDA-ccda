...
* ^identifier.value = "urn:hl7ii:2.16.840.1.113883.10.20.22.4.69:2022-06-01"
* ^version = "2022-06-01"
* classCode 1..1
...
* templateId ^slicing.discriminator[0].type = #value
  ...
  * ^slicing.rules = #open
  * ^comment = "SHALL contain exactly one [1..1] templateId (CONF:4515-14436) such that it"
* templateId contains templateId1 1..1
* templateId[templateId1] ^short = "templateId"
  * ^comment = "SHALL contain exactly one [1..1] templateId (CONF:4515-14436) such that it"
  * root 1..1
  * root = "2.16.840.1.113883.10.20.22.4.69"
    * ^comment = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.22.4.69\" (CONF:4515-14437)."
  * extension 1..1
  * extension = "2022-06-01"
    * ^comment = "SHALL contain exactly one [1..1] @extension=\"2022-06-01\" (CONF:4515-33037)."
* id 1..*
