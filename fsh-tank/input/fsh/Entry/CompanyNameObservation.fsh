...
Description: "This template is intended to be used in addition to the Product Instance template to exchange the Company Name.  The UDI-DI of the medical device may be used to retrieve the **Company Name** in accessGUDID, which should be considered the source of truth."
