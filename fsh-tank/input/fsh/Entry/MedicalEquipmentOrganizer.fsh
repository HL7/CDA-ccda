...
Severity: #error
Expression: "component.where(supply.hasTemplateIdOf(NonMedicinalSupplyActivity)).exists() or component.where(procedure.hasTemplateIdOf(ProcedureActivityProcedure)).exists()"