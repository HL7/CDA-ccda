...
* templateId[primary] ^comment = "SHALL contain exactly one [1..1] templateId (CONF:1098-16566) such that it"
  * root 1..1
  * root = "2.16.840.1.113883.10.20.22.4.85"
    * ^comment = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.22.4.85\" (CONF:1098-16567)."
  * extension 1..1
  * extension = "2014-06-09"
    * ^comment = "SHALL contain exactly one [1..1] @extension=\"2014-06-09\" (CONF:1098-32589)."
* id 1..*
