...
Description: "This template is intended to be used in addition to the Product Instance template to exchange the Model Number associated with the device.  The UDI-DI of the medical device may be used to retrieve the **Model Number** in accessGUDID, which should be considered the source of truth."
