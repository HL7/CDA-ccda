...
* useablePeriod
  * ^short = "(USCDI) Care Team Member Role - Previous Address - Current or prior place where a person may have been located or could have been contacted."
  * ^extension[1].url = "http://hl7.org/fhir/us/core/StructureDefinition/uscdi-requirement"
