...
* component 1..1
  ...
  * structuredBody 1..1
    ...
    * component contains
        ...
        preopDx 1..1 and
        estBloodLoss 1..1 and
        findings 1..1 and
        specimensTaken 1..1 and
        ...
        disposition 0..1 and
        indications 0..1 and
        surgicalDrains 0..1 and
        advDirectives 0..1
    * component[anesthesia] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30486)."
    ...
    * component[complications] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30488) such that it"
    ...
    * component[preopDx] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30490) such that it"
    ...
    * component[estBloodLoss] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30492) such that it"
    ...
    * component[findings] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30494) such that it"
    ...
    * component[specimensTaken] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30496) such that it"
    ...
    * component[procedureDescription] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30498) such that it"
    ...
    * component[postopDx] ^comment = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30500) such that it"
    ...
    * component[implants] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30502) such that it"
    ...
    * component[fluids] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30504) such that it"
    ...
    * component[surgicalProcedures] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30506) such that it"
    ...
    * component[planOfTreatment] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30508) such that it"
    ...
    * component[plannedProcedure] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30510) such that it"
    ...
    * component[disposition] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30512) such that it"
    ...
    * component[indications] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30514) such that it"
    ...
    * component[surgicalDrains] ^comment = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30516) such that it"
