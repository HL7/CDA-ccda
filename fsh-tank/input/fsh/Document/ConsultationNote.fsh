...
Severity: #error
Expression: "component.where(section.hasTemplateIdOf(AssessmentandPlanSection)).exists() implies component.where(section.hasTemplateIdOf(AssessmentSection).exists() or section.hasTemplateIdOf(PlanofTreatmentSection).exists()).empty()"
...
Severity: #error
Expression: "component.where(section.hasTemplateIdOf(ChiefComplaintandReasonforVisitSection)).exists() implies component.where(section.hasTemplateIdOf(ChiefComplaintSection).exists() or section.hasTemplateIdOf(ReasonforVisitSection).exists()).empty()"

Invariant: 1198-9504
Description: "**SHALL** include a Reason for Referral or Reason for Visit section (CONF:1198-9504)."
Severity: #error
Expression: "component.where(section.hasTemplateIdOf(ReasonforReferralSection).exists() or section.hasTemplateIdOf(ReasonforVisitSection).exists()).exists()"
...
Severity: #error
Expression: "component.where(section.hasTemplateIdOf(AssessmentandPlanSection)).exists() or (component.where(section.hasTemplateIdOf(AssessmentSection).exists() or section.hasTemplateIdOf(PlanofTreatmentSection).exists()).count() = 2)"