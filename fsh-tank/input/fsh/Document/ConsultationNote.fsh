...
* templateId[secondary] ^comment = "SHALL contain exactly one [1..1] templateId (CONF:1198-8375) such that it"
  ...
  * root = "2.16.840.1.113883.10.20.22.1.4"
    * ^comment = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.22.1.4\" (CONF:1198-10040)."
  * extension 1..1
  * extension = "2015-08-01"
    * ^comment = "SHALL contain exactly one [1..1] @extension=\"2015-08-01\" (CONF:1198-32502)."
* code 1..1
