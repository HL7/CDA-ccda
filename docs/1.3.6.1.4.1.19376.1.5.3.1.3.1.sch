...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>Section</sch:title>
    <sch:rule context="f:Section">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Section.extension</sch:title>
    <sch:rule context="f:Section/f:extension">
  ...
  <sch:pattern>
    <sch:title>Section.entry.act</sch:title>
    <sch:rule context="f:Section/f:entry/f:act">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
